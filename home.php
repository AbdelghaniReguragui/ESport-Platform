...
<header>
    ...
    <a href="home.php" class="logo"><img src="images\E1.png" width="150px"></a>
      <nav>
        ...
        <div  onclick="menuToggle1();"> 
          <a href="#" class="notification">
              <div><i class="fas fa-bell"></i></div><?php
                $query = "SELECT * from `notifications` where `status` = 'unread' order by `date` DESC";
                if(count(fetchAll($query))>0){
                ?>
              <span class="badge" style="font-size:12px;"><?php echo count(fetchAll($query)); ?></span>
              <?php
                }
                    ?>
              ...
              <li style ="
                         <?php
                            if($i['status']=='unread'){
                                echo "color:red;";
                                $val=$i['id'];
                                $query ="UPDATE `notifications` SET `status` = 'read' WHERE `id` = $val;";
                                performQuery($query);
...
<div class="wrapper">
  ...
  new google.translate.TranslateElement({pageLanguage: 'en'}, 'google_translate_element');
        ...
        ?>
              <div class="see">
               <a href ="streamers1.php"><span class="see-all" style="font-size: 11px;float:right;margin-top:10%;">See more</span></a>
              </div>
        </ul>
    </div>
</div>
...
<div class="recommended_lives"> 
  <div class="see">
    <span class="title">Live channels we think you’ll like</h4>
  </div>
    <div class="live-channel">
              <div class="live-image">
                <a href ="#"><img src="images/v214_0.png" /></a>
              </div>
              <div class="live-info">
                ...
                <div class="live-text">
                    <a href ="#"> <p class="live-title">Overwatch </p></a>
                    <a href ="#">  <p class="live-user">Ganiman</p></a>
                    <a href ="#"> <p class="live-game">Overwatch</p></a>
                </div>
              </div>
    </div>
    <div class="live-channel">
...
<div class="recommended_games">
  <div class="see">
  <span class="title">Games we think you’ll like</h4>
  <a href ="jeux.php"><span class="see-all">See All</span></a>
  </div>
<?php 
$query = "SELECT * FROM jeu LIMIT 6";
$res = mysqli_query($conn, $query);
...
?>
    <div class="game">
              <div class="game-image">
                <a href ="#"><img style="width:100%" src=<?php echo( "data:image/jpeg;base64,".base64_encode($row["IMAGE"])); ?> ></a>
              </div>
              <div class="game-info">
              <div class="game-text">
                <a href ="#"><p class="game-title"><?php echo($row['NOM_JEU']); ?></p></a>
                <a href ="#"><p class="game-followers"><?php echo($row['VIEWERS']); ?> viewers</p></a>
              </div> 
              </div>             
    </div> 
<?php
...
<div class="recommended_lives_tourn">
  <div class="see">
  <span class="title">Live tournaments</h4>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
  <a href ="#"><span class="see-all">See All</span></a>
  </div>
  <div class="live-tourn">
        <div class="tourn-card">
          <img src="images/v240_7.png" style="width:100%">
          <div class="tourn-container">
                <a href ="#"><p class="tourn-title">GG esport </p></a>
                <div class="game-tourn">
                  <div class="img-cropper">
                    <a href ="#"><img src="images/v93_11.png" /></a>
                  </div>
                  <a href ="#"><p class="tourn-game">League of legends</p></a>
                </div>
                <a href ="#"><p class="tourn-register">250 registred</p></a>
                <div class="watch">
...
<div class="recommended_tourn">
  <div class="see">
  <span class="title">Tournament suggestions</h4>&nbsp
  <a href ="tournoibygame1.php"><span class="see-all">See All</span></a>
  </div>
  <?php
  $requete="SELECT * FROM tournoi,jeu WHERE jeu.ID_JEU=tournoi.ID_JEU LIMIT 3";
  ...
  <div class="live-tourn">
        <div class="tourn-card">
          ...
          <div class="tourn-container">
                <a href ="#"><p class="tourn-deadline"><?php echo($row['DATE']); ?></p></a>
                <a href ="#"><p class="tourn-title"><?php echo($row['NOM_TOURNOI']); ?> </p></a>
                <div class="game-tourn">
                  <div class="img-cropper">
                    <a href ="#"><img src="<?php echo( "data:image/jpeg;base64,".base64_encode($row["LOGO"])); ?>" /></a>
                  </div>
                  <a href ="#"><p class="tourn-game"><?php echo($row['NOM_JEU']); ?></p></a>
                </div>
                <a href ="#"><p class="tourn-register"><?php echo($row['SIZE']); ?> Players</p></a>
                <div class="watch">
                  <button type="submit">See information</button>
                </div>
          </div>
        </div>
  </div>
